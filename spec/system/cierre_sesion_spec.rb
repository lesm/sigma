...
RSpec.describe "Cierre de sesión", type: :system do
  ...
  def cajero_crea_arqueo
    fill_in "$200.00", with: 2
  ...
  def cuando_cajero_selecciona_cerrar_caja
  ...
  def cuando_cajero_da_click_en_cerrar_caja
