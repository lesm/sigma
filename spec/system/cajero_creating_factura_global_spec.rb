...
RSpec.describe "Cajero creating a global invoice", type: :system do
  feature "Factura Global" do
    ...
    def cajero_es_redireccionado_a_new_factura_global
    ...
    def cajero_es_redireccionado_a_factura_global
      id = Factura.first.id
